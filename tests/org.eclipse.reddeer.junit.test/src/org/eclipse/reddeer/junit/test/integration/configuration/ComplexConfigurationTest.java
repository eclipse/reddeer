...
public class ComplexConfigurationTest {
	...
	public void numberOfTestRunsWithConfig() throws InitializationError {
		...
		System.setProperty(RedDeerProperties.CONFIG_FILE.getName(), 
				"resources/org/eclipse/reddeer/junit/integration/configuration/requirements.xml");
	...
	public void testRunA() throws InitializationError {
		...
		System.setProperty(RedDeerProperties.CONFIG_FILE.getName(), 
				"resources/org/eclipse/reddeer/junit/integration/configuration/requirementsA.xml");
	...
	public void testRunB() throws InitializationError {
		SuiteConfiguration suiteConfiguration = new SuiteConfiguration(AllRequirementsClass.class);
		System.setProperty(RedDeerProperties.CONFIG_FILE.getName(), "resources/org/eclipse/reddeer/junit/integration/configuration/requirementsB.xml");
	...
	public void testRunAll() throws InitializationError {
		SuiteConfiguration suiteConfiguration = new SuiteConfiguration(AllRequirementsClass.class);
		System.setProperty(RedDeerProperties.CONFIG_FILE.getName(), "resources/org/eclipse/reddeer/junit/integration/configuration/requirements.xml");
