...
public class NewGeneralProjectReferencesWizardPage extends WizardPage{
  private final Logger log = Logger.getLogger(NewGeneralProjectReferencesWizardPage.class);
  
  public NewGeneralProjectReferencesWizardPage(NewGeneralProjectWizardDialog wizardDialog) {
  ...
  public void setProjectReferences(String... referencedProjects){
    ...
    for (String tableItemLabel : referencedProjects){
      ...
      SWTBotTableItem tiReferencedProject  = tbProjectReferences.getTableItem(tableItemLabel);
