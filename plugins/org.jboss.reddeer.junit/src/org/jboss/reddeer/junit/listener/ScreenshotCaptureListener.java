package org.jboss.reddeer.junit.listener;
...
public class ScreenshotCaptureListener extends RunListener {
	
	private final Logger logger = new Logger(ScreenshotCaptureListener.class);
	...
	private void captureScreenshot(Failure fail) {
		String path = null;
		...
		if (pathCreatedSuccessfuly) {
			...
			Image image = null;
			String fileName = path + fail.getTestHeader() + ".png";
