 ...
 */
public class E4WorkbenchLayerException extends RedDeerException {
	 ...
	 */
	public E4WorkbenchLayerException(String message) {
		super(message);
	}
	 ...
	 */
	public E4WorkbenchLayerException(String message, Throwable cause){
		super(message, cause);
	}
