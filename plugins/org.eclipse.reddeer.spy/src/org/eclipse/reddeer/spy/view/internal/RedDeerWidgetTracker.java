...
public class RedDeerWidgetTracker implements Runnable {
	...
	private List<String> getPossibleRedDeerWidget(Control control) {
		...
		if (clazz.equals(Browser.class)) {
			...
			widgets.add(org.eclipse.reddeer.swt.api.Combo.class.getCanonicalName());
		} else if (clazz.equals(ExpandBar.class)) {
			widgets.add(org.eclipse.reddeer.swt.api.ExpandBar.class.getCanonicalName());
		} else if (clazz.equals(Group.class)) {
			widgets.add(org.eclipse.reddeer.swt.api.Group.class.getCanonicalName());
			...
			widgets.add(org.eclipse.reddeer.swt.api.Scale.class.getCanonicalName());
		} else if (clazz.equals(Shell.class)) {
			widgets.add(org.eclipse.reddeer.swt.api.Shell.class.getCanonicalName());
			...
			widgets.add(org.eclipse.reddeer.swt.api.Table.class.getCanonicalName());
			...
			widgets.add(org.eclipse.reddeer.swt.api.ToolBar.class.getCanonicalName());
