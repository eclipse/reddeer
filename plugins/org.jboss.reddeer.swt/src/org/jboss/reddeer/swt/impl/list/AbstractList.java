...
public abstract class AbstractList implements List {
	...
	public void select(String listItem) {
		logger.info("Select list item '" + listItem + "'");
		ListHandler.getInstance().select(list,listItem);
	}

	public void select(int listItemIndex) {
		logger.info("Select list item with index " + listItemIndex);
	...
	public void deselectAll() {
		logger.info("Deselect all list items");
		ListHandler.getInstance().deselectAll(list);
	}
	
	public void selectAll() {
		logger.info("Select all list items");
