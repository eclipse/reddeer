...
/**
 * Represents wizard which can be found in export wizard dialog
 * @author rawagner
 *
 */
public abstract class ExportMenuWizard extends WizardDialog implements TopMenuOpenable{
	 ...
	 */
	public ExportMenuWizard(String text, String... path) {
		super((Shell)null);
