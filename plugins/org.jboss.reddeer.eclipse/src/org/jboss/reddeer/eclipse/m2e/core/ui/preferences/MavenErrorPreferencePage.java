...
public class MavenErrorPreferencePage extends PreferencePage {
	...
	private static final String GROUP_ID = "\"groupId\" duplicate of parent groupId";
	private static final String VERSION = "\"version\" duplicate of parent version";
	private static final String PROJECT_CONFIG = "Out-of-date project configuration";
	private static final String PLUGIN_EXECUTION = "Plugin execution not covered by lifecycle configuration";
	private static final String MANAGED_VERSION = "Overriding managed version";
	...
	//public mavenSeverity SeverityLevels;
